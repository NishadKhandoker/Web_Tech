...
<div class="card">
  <a class="btn" href="index.php?page=alumni.internship.create">+ Post New Internship</a>
  <a class="btn" style="margin-left:10px;background:#6b7280;" href="index.php?page=alumni.applicants">View Applicants</a>
</div>
      ...
      <tbody>
        <?php foreach ($internships as $p): ?>
          <tr>
            ...
            <td style="padding:10px;border-bottom:1px solid var(--border);">
              <a class="btn" href="index.php?page=alumni.internship.edit&id=<?= (int)$p['id'] ?>">Edit</a>

              <form method="post" action="index.php?page=alumni.internship.delete" style="display:inline;">
