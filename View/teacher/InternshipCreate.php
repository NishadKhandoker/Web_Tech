...
<p class="muted">Teacher can post internship opportunities for AIUB students.</p>
...
<div class="card">
  <form method="post" action="index.php?page=teacher.internship.store" enctype="multipart/form-data">
    ...
    <textarea name="requirements" rows="2" required minlength="5"
    ...
    <input type="url" name="apply_link" placeholder="https://company.com/apply">
    ...
    <div style="margin-top:14px;">
      ...
      <a class="btn" style="background:#6b7280;margin-left:8px;" href="index.php?page=teacher.dashboard">Cancel</a>
    </div>
  </form>
</div>
